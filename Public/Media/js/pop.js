...
$.ajax({
    ...
    success:function(data) {
        ...
        if (num == 1 ) {
            ...
            $("#nums").css({"color":"white","background-color":"#88FAE1","font-family":"Arial","font-size":"10px","text-align":"center","border-radius":"50%","display":"inline-block","line-height":"16px","width":"16px","height":"16px","margin-left":"-5px","margin-top":"-30px","margin-right":"20px"});
            $("#entry").css({"position":"relative","color":"#26D7E1"});
            $("#nums").css({"position":"absolute","top":"24px","right":"-22px","background-color":"#88FAE1"});
            $("#entry").mouseover(function(){
                $(this).css("color","#26D7E1");
                $("#nums").css({"color":"white","background-color":"#88FAE1","font-family":"Arial","font-size":"10px","text-align":"center","border-radius":"50%","display":"inline-block","line-height":"16px","width":"16px","height":"16px","margin-left":"-5px","margin-top":"-30px","margin-right":"20px"})
            });
