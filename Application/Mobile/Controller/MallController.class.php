     ...
     */
     public function mygifts(){
        ...
        $model = array(
            'm_name'=>'record',
            'prefix'=>'tab_gift_',
            'field' =>'tab_giftbag.desribe,tab_gift_record.game_name,tab_gift_record.create_time,tab_giftbag.giftbag_name,tab_giftbag.game_id,tab_giftbag.gift_icon',
        ...
        $this->assign('mycount',count($gifts));
        $this->assign('mygifts',$gifts);
