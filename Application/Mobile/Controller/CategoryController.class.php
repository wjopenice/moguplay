...
class CategoryController extends BaseController {
    ...
    public function zixun(){
        //18/3/8 加 查询全部 游戏公告、游戏活动、游戏资讯
        $model = array(
            'm_name'=>'document',
            'prefix'=>'sys_',
            'field' =>'category_id,sys_document.id as notice_id,title,cover_id,create_time,sys_document_article.id,content',
            'join'  =>'sys_document_article on sys_document.id = sys_document_article.id',
            'map'   =>array('display'=>1,'status'=>1),
