...
class GiftController extends BaseController{
    ...
    */
    public function game_sort($game_type=0,$p=0,$id=0){
            ...
            $data=$model
                ->alias('a')
                ->field('a.id,a.game_type_id ,a.icon,a.game_name,b.game_id,b.giftbag_name,b.desribe,b.id as gift_id')
    ...
    public function giftdetail(){
        ...
        $model = array(
            'm_name'=>'Giftbag',
            'prefix'=>'tab_',
            'field' =>'tab_giftbag.id as gift_id,giftbag_name,tab_giftbag.game_name,desribe,tab_giftbag.start_time,tab_giftbag.end_time,tab_giftbag.gift_icon',
