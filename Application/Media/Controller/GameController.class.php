  ...
  */
   public function yxchildren($id = 0, $p = 1){
    ...
    public function dow_url_generate($game_id=null){
        $url = "http://".$_SERVER['HTTP_HOST']."/media.php?s=/Appdw/gamedown/game_id/".$game_id;
