...
class CategoryController extends BaseController {
    ...
    public function gift(){
        $model = array(
            'm_name'=>'Giftbag',
            'prefix'=>'tab_',
            'field' =>'tab_giftbag.id as gift_id,game_id,tab_giftbag.game_name,giftbag_name,giftbag_type,tab_game.icon,tab_giftbag.create_time,tab_giftbag.desribe',
   ...
   public function zixun_adv(){
        $adv = M("Adv","tab_");
        $map['status'] = 1;
        $map['pos_id'] = array('BETWEEN','8,9'); #资讯页广告图id
        $top= $adv->where($map)->order('pos_id ASC')->select();
