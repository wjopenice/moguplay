...
<body>
	...
	<div class="cf top_nav_list">
		...
		<?php if(empty($model["extend"])): ?><div class="tools">
                ...
                <button class="btn ajax-post gre" target-form="ids" url="<?php echo U("GameType/set_status",array("status"=>1,"msg_type"=>3,"field"=>"status_show"));?>">启 用</button>
                <button class="btn ajax-post red" target-form="ids" url="<?php echo U("GameType/set_status",array("status"=>0,"msg_type"=>3,"field"=>"status_show"));?>">禁 用</button>
                <!-- 20170801新增排序 -->
                <button class="btn list_sort deep" url="<?php echo U('sort',array('type'=>0));?>">WEB排序</button>
                <button class="btn list_sort deep" url="<?php echo U('sort',array('type'=>1));?>">APP排序</button>	 </div><?php endif; ?>
		</div>
		<!-- 高级搜索 -->
		<div class="search-form fr cf" style="margin-bottom:-15px;">
            ...
            <!--游戏类型搜索END-->
			<!-- <div class="sleft">
				<input type="text" name="type_name" class="search-input" value="<?php echo I('type_name');?>" placeholder="请输入游戏类型名称">
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('GameType/lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a>
			</div> -->
