...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <?php if(empty($model["extend"])): ?><div class="tools">
                 <a class="btn blue" href="<?php echo U('alipay_limit_add?model='.$model['id']);?>">新 增</a>
        ...
        <div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Promote/alipay_limit','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
            ...
            <table>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center">充值上限</th>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["alipay_limit"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo set_show_time($data['set_alipay_time']);?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                            <a href="<?php echo U('alipay_limit_edit',array('ids'=>$data['id']));?>" class="">编辑</a>
                            <a href="<?php echo U('alipay_limit_del',array('ids'=>$data['id']));?>" class="">删除</a>
                            </td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Promote/alipay_limit');?>');
$(function(){
    //搜索功能
