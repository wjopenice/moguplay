...
<body>
    ...
    <div class="tools">
        <a class="btn blue" href="<?php echo U('Model/add');?>">新 增</a>
        <button class="btn ajax-post gre" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>1));?>">启 用</button>
        <button class="btn ajax-post red" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>0));?>">禁 用</button>
        <a class="btn create" href="<?php echo U('Model/generate');?>">生 成</a>
    </div>
