...
<body>
	...
	<div class="cf top_nav_list">
		<div class="fl button_list">
            <a class="btn blue" href="<?php echo U('letter_add');?>">新 增</a>
        </div>
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('letter');?>">搜索</a>
            </div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["send_account"]); ?></td>
			<td><?php echo ($vo["title"]); ?></td>
			<td><a href="<?php echo U('User/letter_contentlist?id='.$vo['id']);?>">查看全文</a></td>
			<td><?php echo ($vo["type"]); ?></td>
			<td><?php echo get_letter_status($vo['status']);?></td>
			<td><?php echo ($vo["number"]); ?></td>
			<td><?php echo (time_format($vo["create_time"])); ?></td>
			<td>
			     <a  href="<?php echo U('User/letter_edit?id='.$vo['id']);?>" class="">编辑</a>
                 <a href="<?php echo U('User/letter_delete?id='.$vo['id']);?>" class="">删除</a>
            </td>
