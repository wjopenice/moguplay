...
<body>
	...
	<div class="cf top_nav_list">
		...
		<?php if(empty($model["extend"])): ?><div class="tools">
				<a class="btn blue" href="<?php echo U('img_add');?>">新 增</a>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["sort"]); ?></td>
                            
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                            <?php if($data['status'] == 1): ?>开启
                                <?php else: ?>关闭<?php endif; ?>
                           </td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["location"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo set_show_time($data['create_time']);?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                            <a href="<?php echo U('img_edit',array('ids'=>$data['id']));?>" class="">编辑</a>
                            <a href="<?php echo U('img_del',array('ids'=>$data['id']));?>" class="">删除</a>
                            </td>
