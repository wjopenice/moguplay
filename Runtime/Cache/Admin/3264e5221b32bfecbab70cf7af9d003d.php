...
<div class="tab-wrap">
    ...
    <!-- 表单 -->
    <form id="form" action="<?php echo U('Query/withdraw_add?model='.$model['id']);?>" method="post" class="form-horizontal">
        <!-- 基础文档模型 -->
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="r">
                       ...
                       <?php $_result=get_promote_parent_list();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["account"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                       </select>
                    </td>
                    <td class="l"></td>
                    <td class="r">
