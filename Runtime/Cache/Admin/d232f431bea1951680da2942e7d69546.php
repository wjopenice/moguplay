...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <label>充值时间：</label>
                <input type="text" id="time-start" name="time-start" class="text input-3x" <?php if(I('start')!=''): ?>value="<?php echo I('start');?>" <?php else: ?> value="<?php echo I('time-start');?>"<?php endif; ?>  placeholder="起始时间" /> 
                -
                <div class="input-append date" id="datetimepicker"  style="display:inline-block">
                <input type="text" id="time-end" name="time-end" class="text input-3x" <?php if(I('end')!=''): ?>value="<?php echo I('end');?>" <?php else: ?> value="<?php echo I('time-end');?>"<?php endif; ?> placeholder="结束时间" />
           ...
           <!-- 请选择所属渠道 2017/7/11 -->
            ...
            <div class="sleft">
                <div class="drop-down pay_way" style="width: 120px">
                    ...
                    <ul id="sub-sch-menu-pay-way" class="nav-list hidden">
                        ...
                        <li><a href="javascript:;" value="4" style="width: 100px">快发</a></li>
                    </ul>
                </div>
            ...
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>2,'pay_way'=>I('pay_way'), 'user_account'=>I('user_account'), 'promote_id'=>I('promote_id'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'game_id'=>I('game_id'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出</a><span class="totalvalue">(共计充值<i><?php echo ($total); ?></i>元)</span>
            </div>
		</div>
	</div>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                                <?php switch($data['pay_way']): case "0": ?>平台币<?php break;?>
                                    <?php case "1": ?>支付宝<?php break;?>
                                    <?php case "2": ?>微信<?php break;?>
                                    <?php case "4": ?>快发<?php break; endswitch;?>
                            </td>
    ...
    <!-- <span><a href="<?php echo U('Export/expUser',array( 'id'=>2,'pay_way'=>I('pay_way'), 'user_account'=>I('user_account'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出数据(excel格式)</a></span> -->
