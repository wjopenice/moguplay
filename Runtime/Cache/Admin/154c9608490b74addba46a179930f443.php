...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf">
            ...
            <!-- 转入账号搜索 -->
            <div class="sleft">
                <input type="text" name="<?php echo ((isset($model['search_key1']) && ($model['search_key1'] !== ""))?($model['search_key1']):'agents_name'); ?>" class="search-input" value="<?php echo I('agents_name');?>" placeholder="请输入转入账号">
                <!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('propay/lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a> -->
            </div>

            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Charge/agency_list','model='.$model['name'],false);?>">搜索</a>
            </div>
            <!-- 导出功能 -->
           <!--  <div class="input-list">
               <a class="sch-btn" href="<?php echo U('Export/expUser',array('id'=>18,'game_name'=>I('game_name'),'time-start'=>I('time-start'),'time-end'=>I('time-end'),'start'=>I('start'),'end'=>I('end'),));?>">导出</a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["agents_name"]); ?></td>
            <td><?php echo get_typo($vo['type']);?></td>
             <td><?php echo ($vo["amount"]); ?></td>
              <td><?php echo ($vo["promote_account"]); ?></td>
...
//导航高亮
highlight_subnav('<?php echo U('Charge/agency_list');?>');
$(function(){
     $('.ids').ready(function(){
