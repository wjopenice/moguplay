...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf">
            ...
            <!-- </div> -->
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Query/settlement','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>5, 'game_name'=>I('game_name'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出</a>
            </div>
        </div>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo $data['ratio'];?></td>
                            <!-- <td style="border-right:1px solid #DDDDDD;text-align:center"></td> -->
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo $data['money'];?></td>
                            <!-- <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo $data['real_money'];?></td> -->
                            <!-- <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo $data['real_money'];?></td> -->
    ...
    <!-- <span><a href="<?php echo U('Export/expUser',array( 'id'=>5, 'game_name'=>I('game_name'), ));?>">导出数据(excel格式)</a></span> -->
