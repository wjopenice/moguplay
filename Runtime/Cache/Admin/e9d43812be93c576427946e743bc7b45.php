...
<body>
	...
	<div class="cf top_nav_list">
		<div class="fl button_list">
            <a class="btn blue" href="<?php echo U('forbid_add');?>">新 增</a>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="forbid_ip" class="search-input" value="<?php echo I('forbid_ip');?>" placeholder="请输入IP地址">
				<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('index');?>"><i class="btn-search"></i></a> -->
			</div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('User/forbid');?>">搜索</a>
            </div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["forbid_ip"]); ?> </td>
			<td><?php echo ($vo["reg_num"]); ?></td>
			<td>
			     <?php if($vo['type'] == 0): ?>已封
                        <?php elseif($vo['type'] == 1): ?>未封
                        <?php else: ?>未知<?php endif; ?>

			</td>
			<td><span><?php echo (time_format($vo["update_time"])); ?></span></td>
			<td>
			   <!--   <a  href="<?php echo U('User/edit?id='.$vo['id']);?>" class="">编辑</a> -->
				<?php if(($vo["type"]) == "1"): ?><a href="<?php echo U('User/forbid_edit?type=1&id='.$vo['id']);?>" class="ajax-get">拉黑</a>
				<?php else: ?>
				<a href="<?php echo U('User/forbid_edit?type=0&id='.$vo['id']);?>" class="ajax-get">解封</a><?php endif; ?>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('User/forbid');?>');
	</script>
