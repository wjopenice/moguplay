...
<body>
	...
	<div class="cf top_nav_list">
		...
		<?php if(empty($model["extend"])): ?><div class="tools">
                ...
                <button class="btn ajax-post gre" target-form="ids" url="<?php echo U("Message/set_status",array("status"=>1,"msg_type"=>7,"field"=>"status"));?>">修 复</button>
            <button class="btn ajax-post red" target-form="ids" url="<?php echo U("Message/set_status",array("status"=>0,"msg_type"=>8,"field"=>"status"));?>">未修复</button>
			</div><?php endif; ?>
		</div>
		<!-- 高级搜索 -->
		<div class="search-form fr cf">
			...
			<div class="sleft">
				<input type="text" name="op_account" class="search-input" value="<?php echo I('op_account');?>" placeholder="请输入操作人员">
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Message/wrong');?>"><i class="btn-search"></i></a>
			</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Message/wrong');?>');
$(function(){
	//搜索功能
