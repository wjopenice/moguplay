...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Promote/set_balancelist','model='.$model['name'],false);?>">
                搜索
                </a>
            </div>
		</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Promote/set_balancelist');?>');
$(function(){
    //批量删除
    $("#dtnn").click(function(){
      var spCodesTemp = "";
