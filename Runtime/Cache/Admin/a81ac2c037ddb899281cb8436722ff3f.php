...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf" >
            ...
            <!-- <div class="input-append date fl" id="datetimepicker"  style="display:inline-block">
           ...
           <!-- 新增搜索功能 2017/8/14 -->
            ...
            <div class="sleft"  >
                <input type="text" name="server_name" class="search-input" value="<?php echo I('server_name');?>" placeholder="请输入区服名称">
                <!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a> -->
            </div>
            <div class="input-list">
...
$(function(){
    ...
    $("#search").click(function(){
        ...
        var query  = $.param({
                ...
                'server_name': $.trim($("input[name=server_name]").val())
            });
