...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf" style="margin-bottom:-15px;">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('rebatelist/lists','model='.$model['name'],false);?>">搜索</a>
            </div>
                        <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>14, 'game_name'=>I('game_name'), 'promote_name'=>I('promote_name'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), ));?>">导出</a>
            </div>
		</div>
	</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Rebatelist/lists');?>');
$(function(){
	//搜索功能
