...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
			...
			<div class="sleft">
				<input type="text" name="user_name" class="search-input" value="<?php echo I('user_name');?>" placeholder="请输入账号">
			</div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Member/user_change','model='.$model['name'],false);?>">
                搜索
                </a>
            </div>
		</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Member/user_change');?>');
$(function(){
    //批量删除
    $("#dtnn").click(function(){
      var spCodesTemp = "";
