...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('BindSpend/lists','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>10, 'user_account'=>I('user_account'), 'pay_way'=>I('pay_way'), 'promote_id'=>I('promote_id'), 'cp_name'=>I('cp_name'), 'pay_status'=>I('pay_status'), 'pay_game_status'=>I('pay_game_status'), 'game_id'=>I('game_id'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出</a><span class="totalvalue">(共计使用<i><?php echo ($total); ?></i>元)</span>
            </div>
		</div>
    ...
    <!-- <span><a href="<?php echo U('Export/expUser',array( 'id'=>10, 'user_nickname'=>I('user_nickname'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出数据(excel格式)</a></span> -->
