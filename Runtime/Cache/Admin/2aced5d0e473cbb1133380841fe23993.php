            ...
            <table  border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    ...
                    <td class="l">真实下载量</td>
                    <td class="r"><?php echo ($data['dow_num']); ?></td>
                  </tr>
                  <tr>
                    <td class="l">安卓原包下载地址：</td>
                    <td class="r" >
                        <input type="text" class="txt"  readonly="readonly"  <?php if($data['and_dow_address'] == ''): ?>value="暂未上传安卓包" <?php else: ?> value="<?php echo ($_SERVER['HTTP_HOST']); echo U('Down/down_file',array('game_id'=>$data['id'],'type'=>1),'html');?>"<?php endif; ?>
                    </td>
                    <!-- <?php echo ($_SERVER['HTTP_HOST']); ?>/media.php/Down/down_file/game_id/<?php echo ($data['id']); ?> -->
                    <td class="l">第三方安卓原包地址：</td>
                    <td class="r" >
                        <input type="text" class="txt " name="add_game_address" value="<?php echo ($data['add_game_address']); ?>">
                    </td>
                  </tr>
                  <tr>
                    <td class="l">IOS原包下载地址：</td>
                    <td class="r" >
                        <input type="text" class="txt " readonly="readonly"  <?php if($data['ios_dow_address'] == ''): ?>value="暂未上传IPA包" <?php else: ?> value="<?php echo ($_SERVER['HTTP_HOST']); echo U('Down/down_file',array('game_id'=>$data['id'],'type'=>2),'html');?>"<?php endif; ?>
                    </td>
                    <td class="l">第三方IOS原包地址：</td>
                    <td class="r" >
                        <input type="text" class="txt " name="ios_game_address" value="<?php echo ($data['ios_game_address']); ?>">
                    </td>
                  </tr>
                  <tr>
                    <td class="l">游戏类型：</td>
                 ...
                 <tr>
                    ...
                    <td class="r">
                     ...
                     <td class="l">游戏版本号：</td>
                    <td class="r">
                        <input type="text" class="txt" name="version_num" value="<?php echo $data['version_num'];?>" placeholder="格式为纯数字">
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td class="l">绑币折扣：</td>
                    <td class="r">
                        <input type="text" class="txt" name="bind_discount" value="<?php echo ($data['bind_discount']); ?>" placeholder="请输入1-10的数字,如:4.5即为45%">
                  ...
                  <tr>
                    ...
                    <td  class='l'>虚拟下载量</td>
                    <td  class='r'><input type="text" class='txt' name='dow_mynum' value="<?php echo ($data['dow_mynum']); ?>"></td>
                  </tr>
                </tbody>
            </table>
        </div>
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <label class="inp_radio">
                            ...
                            <input type="radio" class="inp_radio" value="2" name="game_status" <?php if(($data['game_status']) == "2"): ?>checked="checked"<?php endif; ?>>下线
                    ...
                    <td class="r">
                        <label class="inp_radio">
                            <input type="radio" class="inp_radio" value="0" name="recommend_status" <?php if(($data['recommend_status']) == "0"): ?>checked="checked"<?php endif; ?>>不推荐
                            <input type="radio" class="inp_radio" value="1" name="recommend_status" <?php if(($data['recommend_status']) == "1"): ?>checked="checked"<?php endif; ?>>推荐
                            <input type="radio" class="inp_radio" value="2" name="recommend_status" <?php if(($data['recommend_status']) == "2"): ?>checked="checked"<?php endif; ?>>热门
                            <input type="radio" class="inp_radio" value="3" name="recommend_status" <?php if(($data['recommend_status']) == "3"): ?>checked="checked"<?php endif; ?>>最新
                        </label>
                    </td>
                  </tr>
                  <tr>
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="r">
                        <input type="text" class="txt" name="partner" value="<?php echo ($data['partner']); ?>">
                        (威富通商户号)
                    </td>
                    <td class="l">威富通秘钥：</td>
                    <td class="r" colspan='3'>
                        <input type="text" class="txt" name="key" value="<?php echo ($data['key']); ?>">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="l">游戏包名：</td>
                    <td class="r">
                        <input type="text" class="txt" name="apk_pck_name" value="<?php echo ($data['apk_pck_name']); ?>">
                        (安卓生成APK时的包名)
                    </td>
                    <td class="l">游戏签名：</td>
                    <td class="r" colspan='3'>
                        <input type="text" class="txt" name="apk_pck_sign" value="<?php echo ($data['apk_pck_sign']); ?>">
                        (安卓生成APK时的签名)
                    </td>
                  </tr>
                </tbody>
