...
<script>
    ...
    <div class="tools auth-botton">
        <button url="<?php echo U('article/clear');?>" class="btn ajax-get red">清 空</button>
        <button url="<?php echo U('article/permit');?>" class="btn ajax-post gre" target-form="ids">还 原</button>
    </div>
