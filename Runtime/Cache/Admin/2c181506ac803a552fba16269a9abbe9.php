	...
	<div class="cf top_nav_list">
     <!--    <div class="fl button_list">
		...
		<div class="search-form fr cf">
             ...
             <div class="d_list">
                <div class="drop-down drop-down12" style="width:100px">
                    <span id="sort-txt" class="sort-txt" data="{I('type')}" style="width:65px">
                        <?php if(I('type') == ''): ?>显示状态
                        <?php elseif(I('type') == 0): ?>正常
                        <?php elseif(I('type') == 1): ?>发布成功
                        <?php elseif(I('type') == 2): ?>交易成功
                        <?php elseif(I('type') == 3): ?>商品下架<?php endif; ?>
                    </span>
                ...
                <input type='hidden' id='type' name="type" class="hiddenvalue" value="<?php echo I('type');?>"></input>
            </div>
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Member/record_8868','model='.$model['name'],false);?>">
                搜索
                </a>
            </div>
		</div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo get_record_type($data['type']);?></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Member/record_8868');?>');
$(function(){
    //显示状态
