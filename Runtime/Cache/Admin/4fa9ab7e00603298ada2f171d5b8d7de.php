...
<div class="main-title cf" style="border-bottom:3px solid  #C1C1C1;margin-bottom:20px ;">
    <h2 style="font-weight: bold;color:#292C33;">平台币发放</h2>
    </div>
    <!-- 标签页导航 -->
    <div class="tab-wrap">
      <ul class="tab-nav nav">
       ...
       <div class="tab-content zc_for">
        <!-- 表单 -->
          ...
          <form id="form1" action="<?php echo U('propay?type=1');?>" method="post" class="form-horizontal">
          ...
          <form id="form2" action="<?php echo U('propay?type=2');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="l">Excel模板：</td>
                <td class="r" colspan='3'>
                   <a href="./Uploads/excel/Pro_Template.xls">下载模板</a>
                </td>
              </tr>
              <tr>
          ...
          <form id="form3" action="<?php echo U('propay?type=3');?>" method="post" class="form-horizontal">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                <td class="l">渠道账号：</td>
...
// $(function(){
    //导航高亮
    highlight_subnav('<?php echo U('Propay/propay');?>');
