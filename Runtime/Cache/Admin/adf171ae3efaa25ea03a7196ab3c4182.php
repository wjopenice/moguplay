	...
	<div class="cf top_nav_list">
       ...
       <!--  <div class="i_list" id="" >
           ...
           <!--  <div class="i_list">
			...
			<!-- </div> -->
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('stat/cpa_spend','model='.$model['name'],false);?>">搜索</a>
            </div>
             <div class="input-list"> 
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>28, 'promote_id'=>I('promote_id'), 'game_id'=>I('game_id'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出</a>
            ...
            <table>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center">充值人数</th>
                    </tr>
                </thead>
                <!-- 列表 -->
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["ucount"]); ?></td>
...
<script type="text/javascript">
        $(function(){
            ...
            var qdzh="<?php echo ($_GET['promote_id']); ?>";
            $("#sel_game").find('select option[value='+gameBh+']').attr("selected","selected");
            $("#sel_game").find('select').comboSelect();
            $("#sel_promote").find('select option[value='+qdzh+']').attr("selected","selected");
