...
<script>
	...
	<div class="cf top_nav_list">
		<div class="fl button_list">
			<div class="btn-group">
				<?php if(($allow) > "0"): ?><button class="btn document_add blue" <?php if(count($model) == 1): ?>url="<?php echo U('article/add',array('cate_id'=>$cate_id,'pid'=>I('pid',0),'model_id'=>$model[0],'group_id'=>$group_id));?>"<?php endif; ?>>新 增
			...
			<button class="btn ajax-post gre" target-form="ids" url="<?php echo U("Article/move");?>">移 动</button>
			<button class="btn ajax-post org" target-form="ids" url="<?php echo U("Article/copy");?>">复 制</button>
			<button class="btn ajax-post deep" target-form="ids" hide-data="true" url="<?php echo U("Article/paste");?>">粘 贴</button>
			...
			<button class="btn list_sort deep" url="<?php echo U('sort',array('cate_id'=>$cate_id,'pid'=>I('pid',0)),'');?>">排 序</button>
		</div>
