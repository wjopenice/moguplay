...
<body>
	...
	<div class="cf top_nav_list">
		...
		<?php if(empty($model["extend"])): ?><div class="tools">
				<a class="btn blue" href="<?php echo U('version_add');?>">新 增</a>
				<!-- <button class="btn ajax-post confirm red" target-form="ids" url="<?php echo U('version_del?model='.$model['id']);?>">删 除</button> -->
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["serverversion"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["appname"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["serverflag"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["lastforce"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["upgradeinfo"]); ?></td>
                            
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                            <?php if($data['is_must'] == 1): ?>强更
                                <?php else: ?>不强更<?php endif; ?>
                           </td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo set_show_time($data['create_time']);?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center">
                            <a href="<?php echo U('version_edit',array('id'=>$data['id']));?>" class="">编辑</a>
                            <a href="<?php echo U('version_del',array('id'=>$data['id']));?>" class="">删除</a>
                            </td>
