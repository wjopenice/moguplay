	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
			...
			<div class="sleft">
				...
				<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Giftbag/record');?>"><i class="btn-search"></i></a> -->
			</div>
            <div class="sleft">
            <input type="text" name="prefix" class="search-input" value="<?php echo I('prefix');?>" placeholder="激活码前缀" />
            </div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Giftbag/exchange_record');?>">搜索</a>
            </div>

            <div class="input-list">
               <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>26, 'user_account'=>I('user_account'), 'prefix'=>I('prefix') ));?>">导出</a>
            </div> 
		</div>
	</div>
   ...
   <!-- 数据列表 -->
    ...
    <tbody>
        <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                 <?php if($vo['status'] == 0): ?>失败
                        <?php elseif($vo['status'] == 1): ?>成功
                        <?php else: ?>未知<?php endif; ?>

            </td>
            <td><?php echo ($vo["cdkey"]); ?></td>
            <td><?php echo ($vo["describe"]); ?>*<?php echo ($vo["goods_num"]); ?></td>
            <td><?php echo (time_format($vo["create_time"])); ?></td>
<!-- 
            <td>
              <a  href="<?php echo U('Giftbag/exchange_edit?id='.$vo['id']);?>" class="">编辑</a> 
              <a href="<?php echo U('Giftbag/exchange_del?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
            </td> -->
    ...
    <!-- <span><a href="<?php echo U('Export/expUser',array( 'id'=>11, 'game_name'=>I('game_name'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出数据(excel格式)</a></span> -->
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Giftbag/exchange_record');?>');
$(function(){
	//搜索功能
