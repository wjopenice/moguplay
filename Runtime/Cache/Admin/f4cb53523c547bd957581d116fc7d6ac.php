      ...
      <ul class="tab-nav nav">
       ...
       <div class="tab-content zc_for">
        <!-- 表单 -->
          ...
          <form id="form1" action="<?php echo U('bdfirstpay?type=1');?>" method="post" class="form-horizontal">
          ...
          <form id="form2" action="<?php echo U('bdfirstpay?type=2');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
          ...
          <form id="form3" action="<?php echo U('bdfirstpay?type=3');?>" method="post" class="form-horizontal">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                  <td class="l">游戏名称：</td>
