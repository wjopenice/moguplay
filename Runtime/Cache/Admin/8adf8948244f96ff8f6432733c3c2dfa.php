...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Repair/repairList','model='.$model['name'],false);?>">搜索</a>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('Repair/repairEdit',array('orderNo'=>$data['pay_order_number']));?>">补单</a>
                        </td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Repair/repairList');?>');
$(function(){
    //搜索功能
