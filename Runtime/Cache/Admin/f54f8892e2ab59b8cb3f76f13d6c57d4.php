...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <!-- <div class='sleft'>
                        <input type="text" id="time-start" name="time-start" class="text input-2x" value="<?php echo I('time-start');?>" placeholder="修改起始时间" /> -                     
                        <div class="input-append date" id="datetimepicker"  style="display:inline-block">
                            <input type="text" id="time-end" name="time-end" class="text input-2x" value="<?php echo I('time-end');?>" placeholder="修改结束时间" />
			...
			<div class="sleft">
                    <input type="text" name="user_account" class="search-input" value="<?php echo I('user_account');?>" placeholder="请输入玩家账号">
				<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Mend/record','model='.$model['name'],false);?>"><i class="btn-search"></i></a> -->
			</div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Mend/record','model='.$model['name'],false);?>">搜索</a>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data['promote_account_to']); ?></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Mend/record');?>');
$(function(){
	//搜索功能
