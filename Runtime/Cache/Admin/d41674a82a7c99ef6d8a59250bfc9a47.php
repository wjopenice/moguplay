...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
			...
			<div class="sleft">
				<input type="text" name="account" class="search-input" value="<?php echo I('account');?>" placeholder="请输入玩家账号">
				<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Mend/lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a> -->
			</div>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><input class="ids" type="checkbox" value="<?php echo ($data['uid']); ?>" name="ids[]"></td>
                            ...
                            <?php if(get_parent_promoteto($data['promote_id']) != '' ): echo get_promote_name($data['promote_id']); echo get_parent_promoteto($data['promote_id']);?>
                            <?php else: ?>
                                <?php echo get_promote_name($data['promote_id']); endif; ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><a href="<?php echo U('Mend/edit?id='.$data['id']);?>">补链</a></td>
