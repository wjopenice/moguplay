    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf">
            ...
            <div class="input-list">
                <label>注册时间：</label>
                <input type="text" id="time-start" name="time-start" class="text input-2x" value="<?php echo I('time_start');?>" placeholder="起始时间" /> 
                -
                <div class="input-append date" id="datetimepicker"  style="display:inline-block">
                <input type="text" id="time-end" name="time-end" class="text input-2x" value="<?php echo I('time_end');?>" placeholder="结束时间" />
                <span class="add-on"><i class="icon-th"></i></span>
                </div>
            </div>
            <!-- <div class="i_list" id="" >
             ...
             <div class="chose_game"  id="sel_game" style="float:left;width:172px;height:28px;line-height:28px;margin:0 5px 0 -5px;">
                        <select>
                            ...
                            <?php $_result=get_game_list();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(I('get.game_id') == $vo['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["game_name"]); ?></option>
                            <?php else: ?>
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Promote/ch_reg_list','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array( 'id'=>3, 'account'=>I('account'), 'time_start'=>I('time_start'), 'time_end'=>I('time_end'), 'promote_name'=>I('promote_name'), 'game_id'=>I('game_id'), 'start'=>I('start'), 'end'=>I('end'), ));?>">导出</a><span class="totalvalue">(总计注册:<i><?php echo ($count); ?></i>)</span>
            </div>
        </div>
    </div>
...
<link href="/Public/Admin/css/combo.select.css" rel="stylesheet" type="text/css">
<style>
