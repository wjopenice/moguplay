...
<div class="main-title cf" style="border-bottom:3px solid  #C1C1C1;margin-bottom:20px ;">
    <h2 style="font-weight: bold;color:#292C33;">推广绑定平台币发放</h2>
    </div>
    <!-- 标签页导航 -->
    <div class="tab-wrap">
      <ul class="tab-nav nav">
       ...
       <div class="tab-content zc_for">
        <!-- 表单 -->
          ...
          <form id="form1" action="<?php echo U('bang_propay?type=1');?>" method="post" class="form-horizontal">
          ...
          <form id="form2" action="<?php echo U('bang_propay?type=2');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
          ...
          <form id="form3" action="<?php echo U('bang_propay?type=3');?>" method="post" class="form-horizontal">
          <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
                  <td class="l">游戏名称：</td>
...
// $(function(){
    //导航高亮
    highlight_subnav('<?php echo U('BangPropay/bang_propay');?>');
     //搜索下拉框
    $(function(){
       $('select').comboSelect();
