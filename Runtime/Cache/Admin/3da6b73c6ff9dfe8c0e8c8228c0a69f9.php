...
<body>
    ...
    <div class="cf top_nav_list">
      ...
      <!--       <div class="i_list" >
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Repair/repairRecordList','model='.$model['name'],false);?>">搜索</a>
            </div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Repair/repairRecordList');?>');
$(function(){
    //搜索功能
