	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf" style="margin-bottom:-15px;">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Links/lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a>
			</div>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Links/lists');?>');
$(function(){
	//搜索功能
