...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Member/points_record','model='.$model['name'],false);?>">搜索</a>
            </div>
         <!--    <div class="input-list"> 
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo ($data["points"]); ?></td>
                            <td style="border-right:1px solid #DDDDDD;text-align:center"><?php echo get_pay_way($data['pay_way']);?></td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Member/points_record');?>');
$(function(){
	//搜索功能
