...
<body>
	...
	<div class="tab-wrap">
		...
		<div class="tab-content">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($i % 2 );++$i; switch($config["name"]): case "APP_SET_COVER": ?><div class="form-item">
