...
<body>
    ...
    <div class="cf top_nav_list">
        ...
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                <input type="text" name="user_name" id='user_name' class="search-input" value="<?php echo I('user_name');?>" placeholder="请输入账号">
            </div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Member/set_bindlist','model='.$model['name'],false);?>">
                搜索
                </a>
            </div>
             <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array('id'=>21, 'user_name'=>I('user_name'), 'money'=>I('money'), 'admin_name'=>I('admin_name'), 'game_name'=>I('game_name'), 'create_time'=>I('create_time'), 'time-start'=>I('time-start'), 'time-end'=>I('time-end'), 'start'=>I('start'), 'end'=>I('end'),));?>">导出</a>
            ...
            <table>
                ...
                <tbody>
                    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                            <?php if(empty($data["game_name"])): ?><lable style="color: red">全部游戏</lable>
                            <?php else: ?>
                            <?php echo ($data["game_name"]); endif; ?>
                            </td>
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Member/set_bindlist');?>');
$(function(){
    //批量删除
    $("#dtnn").click(function(){
      var spCodesTemp = "";
