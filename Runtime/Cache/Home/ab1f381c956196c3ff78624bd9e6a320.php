...
<script type="text/javascript" src="/moguplay/Public/Home/js/jquery.validate.js"></script>
<script type="text/javascript" src="/moguplay/Public/Home/js/register.js"></script>
...
<div class="reg_list">
	<div class="reg_form section">
        <form class="login_form" id="login_form" action="/moguplay/index.php?s=/Home/Index/register" method="post" novalidate="novalidate" >
			<div class="reg-con">
			  <h2>注册信息</h2>
				<ol class="clearfix">
                ...
                <div class="rulebox">
				  <p>
					...
					<label for="agreement">我已阅读并接受<a href="<?php echo U('rule');?>" target="_blank">《手上科技渠道合作协议》</a></label>
