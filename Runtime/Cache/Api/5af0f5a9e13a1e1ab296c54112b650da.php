...
<head>
    <meta charset="UTF-8">
    <title>选择银行支付</title>
    <link rel="stylesheet" href="/Public/Api/css/index.css">
    <style>
...
<div class="navHeight" >
    <!--  搜索栏  -->
    <div class="search cf">
        <a href="javascript:void(0)"><img src="/Public/Api/image/logo.png" width="159" height="56" alt="" class="logo fl"></a>
    </div>
    <!--  分割线   -->
...
if($data){ ?>
    ...
    <div class="payInfoBoxWrap">
        <div class="payTit cf">
            ...
            <p class="payTitCon fl">订单信息来源：<span><?php echo $data['pid']?></span></p>
        </div>
        <div class="goodsInfoBox">
            <table class="goodInfoTable" cellspacing = 0 cellpadding = 0>
                ...
                <tr>
                    ...
                    <td><?php echo $data['productNum']?></td>
                    <td><?php echo $data['payerName']?></td>
                    <td><span><?php echo $data['orderAmount'] ?></span>元</td>
                </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="payInfoCon">
                ...
                <ul class="payInfoUl cf" id="BTC">
                    <li class="subPayBank fl cf" data-bankName="cmb">
                        ...
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/cmb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf" data-bankName="icbc">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/icbc.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf" data-bankName="ccb">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/ccb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf" data-bankName="abc">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/abc.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf" data-bankName="cmbc">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/cmbc.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="spdb">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/spdb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="hxb">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/hxb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="cgb">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/cgb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="cib">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/cib.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="ceb">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/ceb.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="comm">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/comm.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="boc">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/boc.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="citic">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/citic.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="bos">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/bos.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="pingan">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/pingan.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="psbc">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/psbc.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1556">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1556.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="dalian">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/dalian.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1541">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1541.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1593">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1593.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1660">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1660.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1669">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1669.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1552">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1552.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1608">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1608.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="b1629">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/b1629.png" alt=""></div>
                    </li>
                    <li class="subPayBank fl cf"  data-bankName="nb_unionpay">
                        <i class="fl isChoseBank"></i>
                        <div class="bankImgBox fl"><img src="/Public/Api/image/bank/nb_unionpay.png" alt=""></div>
                    </li>
        ...
        <div class="payMoney">
            <p class="shouldPay">应付人民币：<span class="money"><?php echo $data['orderAmount'] ?></span>元</p>
...
<script src="/Public/Api/js/jquery.js"></script>
<script src="/Public/Api/js/index.js"></script>
<script>
