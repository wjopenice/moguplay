...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Member/noidcard';
            ...
            <div class="content clearfix">
                <div class="con_l" id="safeCenter_l">
                     <ul>
                       ...
                       <?php if($user['idcard'] == ''): ?><li class="current"><a href="<?php echo U('Member/noidcard');?>"> <span style="background-position: -42px -141px;"></span>实名认证</a></li>
                       <?php else: ?>
                          <li ><a href="<?php echo U('Member/idcard');?>"> <span style="background-position: -42px -141px;"></span>实名认证</a></li><?php endif; ?>
                    </ul>
                </div>
                <div class="con_r" id="safeCenter_r">
                    <!--实名认证-->

                    <div id="nobind1" style="display:block">
                        <img src="/Public/Media/image/personalcenter/safecenter/1.png" alt="" class="first">
                        <p class="basic">根据2010年8月1日实施的《网络游戏管理暂行办法》，网络游戏用户需使用有效身份证件进行实名注册。为保证流畅游戏体验，享受健康游戏生活，请广大游戏玩家尽快实名注册，且实名信息将不可更改。</p>
                        <p class="current" style="margin-top: 45px">当前账号：<span class="account" id="uname"><?php echo ($user['account']); ?></span></p>
                        <div class="reset"><span class="h" style="text-indent: 2em">密码：</span> <input type="password" class="shuru" id="telpassword"> <span id="teltips" class="teltipss"> <i class="star">* </i><span class="zi"> 请输入密码</span></span></div>
                        <input type="submit" value="完&nbsp;成" class="completeerror" id="achieve">
                    </div>

                    <div id="nobind2" style="display:  none">
                        <img src="/Public/Media/image/personalcenter/safecenter/2.png" alt="" class="first">
                        <p class="basic">根据2010年8月1日实施的《网络游戏管理暂行办法》，网络游戏用户需使用有效身份证件进行实名注册。为保证流畅游戏体验，享受健康游戏生活，请广大游戏玩家尽快实名注册，且实名信息将不可更改。</p>
                        <p class="current" style="margin-top: 45px">当前账号：<span class="account"><?php echo ($user['account']); ?></span></p>
                        <div class="reset"><span class="h" style="text-indent: 2em">姓名：</span> <input type="text"  id="name"><span id="nametips"><i class="star">* </i><span class="zi"> 请输入您的真实姓名</span></span></div>
                        <div class="reset"><span class="h">身份证号：</span> <input type="text"  id="idcard"><span id="idcodetips"><i class="star">* </i><span class="zi"> 请输入您的身份证号</span></span></div>
...
<script>
    ...
    var cardurl="<?php echo U('Member/card');?>";
    var idcardurl="<?php echo U('Member/idcard');?>";
</script>

</body>
<script src="/Public/Media/js/jquery-1.11.1.min.js"></script>
<script src="/Public/Media/js/verifyidcard.js"></script>
<script src="/Public/Media/js/idcard.js"></script>
</html>
