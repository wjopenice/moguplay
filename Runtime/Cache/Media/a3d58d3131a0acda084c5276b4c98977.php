...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Member/nobindemail';
...
<script src="/Public/Media/js/js.js"></script>
    ...
    <style>
        ...
        #pc_main_con .safeCenter .content .con_r #nobind1 .postbox{
            margin-left: 285px;
            margin-bottom: 40px;
            margin-top: 20px;
            color: #333;
        ...
        #pc_main_con .safeCenter .content .con_r #nobind1 .postbox span{
            color: #8C97CB;
            font-size: 16px;
            margin-left: 10px;
        }
            ...
            <div class="content clearfix">
                <div class="con_l" id="safeCenter_l">
                      <ul>
                       ...
                       <?php if($user['email'] == ''): ?><li  ><a href="<?php echo U('Member/bindemail');?>"><span style="background-position:-42px -109px;margin-top: 23px;"></span>绑定邮箱</a></li>
                       <?php else: ?>
                ...
                <div class="con_r" id="safeCenter_r">
                    ...
                    <?php switch($m): case "1": ?><div id="nobind1" style="display:block ">
                       <p class="postbox">绑定的邮箱 ：<span id="uemails"><?php echo ($user["email"]); ?></span></p>
                        <a href="javascript:;" class="completesuccess" id="changed">更换绑定邮箱</a>
                    </div>

                    <div id="nobind1_1" style="display: none; ">
                    ...
                    <?php case "2": ?><div  id="nobind2" style="display:block; ">
                             <input type="hidden" name="uname" id="uname" value="<?php echo ($user["account"]); ?>">
                            <div class="reset"><span class="h">绑定邮箱：</span> <input type="text"  id="emailcenter"> <span id="centeremailtips" class="teltips"> <i class="star">* </i><span class="zi"> 请输入您的常用邮箱</span></span></div>
                    ...
                    <div id="nobind3" style="display:none;">
                        <div >
                            <p class="confirm">验证链接已发送至邮箱<a href="javascript:;" target="_blank" class="mail" id="get_email"></a>,请在24小时内查收验证</p>
                            <p class="confirm2">登录邮箱并按邮箱提示操作即可</p>
                        </div>
                        <a  class="completesuccess" id="achieve3">立即登录邮箱</a>
...
<script src="/Public/Media/js/unbindingemail.js"></script>
<script>
