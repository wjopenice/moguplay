...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Member/pcmsghasread';
...
<script src="/Public/Media/js/js.js"></script>
    ...
    #pagation .jump span{display: inline-block;font-size:14px;padding:5px 10px;cursor:pointer;color:#4c4c4c;}
    #pc_main_con .messageCenter .title span{float: left;width:21px;height: 21px;margin:15px 20px 0 20px;background-image: url(/Public/Media/image/personalcenter/pcsprits.png) ; background-repeat:no-repeat ;}
    </style>
    <div id="pc_main_con" >
        <div class="messageCenter" >
            ...
            <div class="content">
                <ul class="message_title clearfix">
                    <li ><a href="<?php echo U('Member/pcmessage');?>">全部消息</a></li>
                    <li><a href="<?php echo U('Member/pcmsgunread');?>">未读消息</a></li>
                    <li  class="current" ><a href="<?php echo U('Member/pcmsghasread');?>">已读消息</a></li>
                </ul>
                <div class="showMessage">
                    <div class="chose clearfix">
                        ...
                        <div class="buttons clearfix">
                            <input type="button" id="hasRead" disabled style="color:#ccc;cursor: text;" value="标记已读" />
                    ...
                    <ul class="items">
                      <?php if(is_array($read_data)): $i = 0; $__LIST__ = $read_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alldata): $mod = ($i % 2 );++$i;?><li class="clearfix hasReadMsg" id="<?php echo ($alldata["id"]); ?>">
                            <div class="img">
                                <img src="/Public/Media/image/personalcenter/msgcenter/quanxuankuang_1.png"/>
                            </div>
                            <input type="hidden" value="1"/>
                            <a href="<?php echo U('Member/detail',array('mid'=>$alldata['id'],'type'=>3));?>"  class="clearfix">
       ...
       if(dataLength>pageSize){        
        page({
            ...
            callBack : function(now,all){
                window.location.href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/media.php?s=/Member/pcmsghasread/p/"+now+'/pagesize/'+pageSize+'.html';
            }
        });
    }else{
