...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Member/idcard';
            ...
            <div class="content clearfix">
                <div class="con_l" id="safeCenter_l">
                     <ul>
                       ...
                       <?php if($user['idcard'] == ''): ?><li ><a href="<?php echo U('Member/noidcard');?>"> <span style="background-position: -42px -141px;"></span>实名认证</a></li>
                       <?php else: ?>
                          <li class="current"><a href="<?php echo U('Member/idcard');?>"><span style="background-position: -42px -141px;"></span>实名认证</a></li><?php endif; ?>
                    </ul>
                </div>
                <div class="con_r" id="safeCenter_r">
                    ...
                    <div id="bind">
                        <p class="one">您已完成实名认证</p>
                        <p class="two" style="text-indent: 2em">姓名 : <span><?php echo ($user["real_name"]); ?></span></p>
                        <p class="three">身份证号 : <span><?php echo ($user["idcard"]); ?></span></p>
                    </div>
