...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Member/pcmsgunread';
        ...
        <div class="messageCenter" >
            ...
            <div class="content">
                <ul class="message_title clearfix">
                    ...
                    <li class="current"><a href="<?php echo U('Member/pcmsgunread');?>">未读消息</a></li>
                ...
                <div class="showMessage">
                    ...
                    <ul class="items">
                       <?php if(is_array($unread_data)): $i = 0; $__LIST__ = $unread_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alldata): $mod = ($i % 2 );++$i;?><li class="clearfix" id="<?php echo ($alldata["id"]); ?>">
                            <div class="img">
                                <img src="/Public/Media/image/personalcenter/msgcenter/quanxuankuang_1.png"/>
                            </div>
                            <input type="hidden" value="0"/>
                            <a href="<?php echo U('Member/detail',array('mid'=>$alldata['id'],'type'=>2));?>"  class="clearfix">
       ...
       if(dataLength>pageSize){        
        page({
            ...
            callBack : function(now,all){
                window.location.href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/media.php?s=/Member/pcmsgunread/p/"+now+'/pagesize/'+pageSize+'.html';
            }
        });
    }else{
