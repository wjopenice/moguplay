...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Service/kfzj';
...
<div class="kf container clearfix">
    <div class="kf-t">
        <p>当前位置： <a href="<?php echo U('kefu');?>">客服中心 </a> > <a href="javascript:;">常见问题</a></p>
    </div>
    <div class="kf-b clearfix">
         ...
         <div class="tabItemContainer">
            ...
            <li  class="tabItemCurrent"><span class="icon-cj"></span><a href="<?php echo U('Service/kfzj');?>">常见问题</a></li>
        </div>

        <div class="tabBodyContainer">
            <div class="content">
                <div class="content-t" id="41">
                    <p class="question">
                        Q:为什么我登录游戏的时候，登不上去，没有任何提示？
                    </p>
                    <p class="answer"><span class="an">A:</span>
                    <span class="zwt">
                     亲爱的玩家：您好！建议您检查网络设置，确保网络畅通无延迟情况，然后清理下内存和应用数据。感谢您对手上科技游戏平台的支持，祝您游戏愉快！
                    </span></p>
                </div>
                
                <div class="content-t" id="42">
                    <p class="question">Q: 
                    闪退\掉线\卡机如何处理?
                    </p>
                    <p class="answer"><span class="an">A:</span>
                    <span class="zwt" >
                    亲爱的玩家您好，请您先加客服QQ：106778379，进行客服咨询，查看是否为游戏更新版本或例行维护导致，如为个别现象，请您尝试以下方法：
                    </span>
                    <span class="zwt">
                    ...
                    <span class="zwt">
                    如不能解决问题，请您准备以下材料提交客服人员：账号、游戏名称、所在区服、游戏角色、使用的网络、手机品牌、手机型号、手机系统版本。
                    </span></p>
                </div>

                <div class="content-t" id="43">
                    <p class="question">Q: 
                    忘记游戏所在区服怎么办?
                    </p>
                    <p class="answer"><span class="an">A:</span>
                    <span class="zwt">
                     亲爱的玩家您好，请您提供账号名称(包括绑定的手机)、角色名称、等级、职业，以便我们尽快帮助您。
                    </span></p>
                </div>
                <div class="content-t" id="48">
                    <p class="question">Q:
                        如果真的忘记游戏所在区服怎么办?
                    </p>
                    <p class="answer"><span class="an">A:</span>
                    <span class="zwt">
                     亲爱的玩家您好，请您真心提供账号名称(包括绑定的手机)、角色名称、等级、职业，以便我们尽快帮助您。
                    </span></p>
                </div>
            </div>
        </div>
