...
<div class="pc_main">
    ...
    var ACTION_STR = '/media.php?s=/Exchange/index';
...
<style type="text/css">
.exChangeBox{display:block;width: 900px;height: 460px;margin: 80px auto;}
</style>
    

    <img src="/Public/Media/image/no-changeCenter.png" class="exChangeBox">
   ...
   // 点击兑换记录判断是否登录跳转到兑换记录的页面
    $(".extab").find(".two").click(function(){
       $.ajax({
                type:'post',
                dataType:'json',              
                url:"<?php echo U('Exchange/is_login');?>",
                async:false,
                success:function(data) {
                    if (parseInt(data.status) == 1 ) {
//                    登录成功时候的状态
                   window.location.href="<?php echo U('record');?>";
                    }
